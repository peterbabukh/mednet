export default {
  ...
  'common.button.next': 'Вперед',
  'common.button.previous': 'Назад',
  'common.button.submit': 'Отправить',
  'common.button.register': 'Зарегистрироваться',
  'common.button.okRegisterMe': 'Да, зарегистрируйте меня',
  'common.button.noLater': 'Нет, позже',

  'localeToggle.en': 'EN',
  'localeToggle.ru': 'RU',

  'site.theme.defaultTheme': 'Светлая Тема',
  'site.theme.darkTheme': 'Темная Тема',
  ...
  'errors.db.dataNotHandledByClientDb':
    'The data failed to be handled properly by the client database.',
  'errors.data.notLoaded': 'The data failed to be loaded.',
  'errors.notSelectable': 'Oops! Not selectable.',
  'errors.data.notFound': 'No data found.',
  'errors.operationFailed': 'The operation failed.',
  'errors.operationFailed.withErrors':
